...
function ContactsLogo({ width, height }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" style={{ width: width, height: height }} focusable="false">
