...
function LinkedInFullLogo({ width, height, fill }) {
  return (
    <svg
      ...
      <g class="linkedin-text">
        ...
        <path
          ...
          fill={fill}></path>
        <polygon fill={fill} points="38 8 34.5 8 31 12 31 3 28 3 28 18 31 18 31 13 34.699 18 38.241 18 34 12.533"></polygon>
        <path
        ...
        <path
          ...
          fill={fill}></path>
        <polygon fill={fill} points="3 3 0 3 0 18 9 18 9 15 3 15"></polygon>
      </g>
    </svg>
  );
}

export default LinkedInFullLogo;
